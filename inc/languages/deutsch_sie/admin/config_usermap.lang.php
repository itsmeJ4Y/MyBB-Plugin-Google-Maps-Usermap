 ...
 *
 * Sie sollten zusammen mit diesem Programm eine Kopie der GNU General Public License erhalten haben.
...
$l['admin_log_config_usermap_edit_place'] = "Geänderte Benutzer-Orte/-plätze #{1} ({2})";
$l['admin_log_config_usermap_delete_place'] = "Gelöschte Benutzer-Orte/-plätze #{1} ({2})";
$l['admin_log_config_usermap_order_places'] = "Sortierte Benutzer-Orte/-plätze";
...
$l['nav_manage_places_desc'] = "Hier können Sie die Benutzerkarten-Orte/Plätze in Ihrem Forum bearbeiten.";
$l['nav_add_place_desc'] = "Hier können Sie einen Benutzerkarten-Ort/Platz erstellen.";
$l['nav_edit_place_desc'] = "Hier können Sie einen Benutzerkarten-Ort/Platz ändern.";
$l['nav_manage_pinimgs_desc'] = "Hier können Sie die Benutzerkarten-PIN-Bilder in Ihrem Forum bearbeiten.";
$l['nav_add_pinimg_desc'] = "Hier können Sie ein Benutzerkarten-PIN-Bild hinzufügen.";
$l['nav_edit_pinimg_desc'] = "Hier können Sie ein Benutzerkarten-PIN-Bild bearbeiten.";
...
$l['error_missing_lat'] = "Kein Breitengrad (latitude) für diesen Ort/Platz angegeben";
...
$l['delete_place_confirmation'] = "Möchten Sie den Ort/Platz wirklich löschen?";
...
$l['delete_pinimg_confirmation'] = "Möchten Sie das PIN-Bild wirklich löschen?";
...
$l['setting_group_usermap_desc'] = "Hier finden Sie die Einstellungen, um das Usermap-Plugin zu konfigurieren. Bei Fragen zum benötigen API-Schlüssel bitte die im ACP angegebenen Links verwenden bzw. im MyBB-Forum \"https://mybb.de/forum/thread-30501.html\" fragen.";

$l['setting_usermap_apikey'] = "API-Schlüssel für \"Maps JavaScript\"";
$l['setting_usermap_apikey_desc'] = "Nachstehend den benötigten API-Schlüssel für das Maps Javascript <i>(Darstellung der interaktiven Karte)</i>, welchen Sie in einem Google-Maps-Konto generieren müssen, eintragen..<br /><b>Wichtig:</b> Soweit noch nicht vorhanden, müssen Sie bei Google ein <a href=\"https://tinyurl.com/y48cdkow\" target=\"_blank\" rel=\"noopener\">Konto</a> einrichten. Der monatliche <a href=\"https://tinyurl.com/y3p9zps5\" target=\"_blank\" rel=\"noopener\">Freibetrag</a> <i>(Stand: 04/2019)</i> reicht für ein MyBB-Forum vollkommen aus.<br /><b>Hinweis:</b> Geben Sie in Ihrem Google-Maps-Konto <i>(unter API-Einschränkung)</i> nur den/die Schlüssel/n die API-Einschränkungen:<br />\"Maps JavaScript API\", \"Geocoding API\", \"Places API\", \"Maps Elevation API\" und \"Maps Embed API\" frei. Alle Informationen zum Bezug eines API-Schlüssels finden Sie <a href=\"https://cloud.google.com/maps-platform/maps/?hl=de\" target=\"_blank\" rel=\"noopener\">\"hier\"</a> und <a href=\"https://agentur-blueline.de/blog/google-maps-api-key-anleitung\" target=\"_blank\" rel=\"noopener\">hier</a>";

$l['setting_usermap_apikeytwo'] = "API-Schlüssel für \"Geocoding\"";
$l['setting_usermap_apikeytwo_desc'] = "Nachstehend den Schlüssel für das Geocoding <i>(Umwandlung von Adressen in geografische Koordinaten oder umgekehrt > erforderlich um einen Marker bzw. PIN in der Karte zu setzen)</i> eintragen.<br /><b>Tipp:</b> Manchmal kann es ausreichend sein, den vorstehenden Schlüssel <i>(aus Maps JavaScript)</i> einzutragen. Wenn es nicht funktionieren sollte, müssen Sie einen gesonderten Schlüssel in Ihrem GoogleMaps-Konto generieren.";

$l['setting_usermap_apikeythree'] = "API-Schlüssel für \"Elevation\"";
$l['setting_usermap_apikeythree_desc'] = "Nachstehend <i>(bei Bedarf)</i> den erforderlichen API-Schlüssel für Elevation <i>(um die Höhendaten definierter Standorte abzufragen)</i> eintragen. Den Schlüssel müssen Sie in Ihrem GoogleMaps-Konto generieren.<br /><b>Tipp:</b> Manchmal kann es ausreichend sein, den ersten Schlüssel <i>(aus Maps JavaScript)</i> einzutragen. Wenn es nicht funktionieren sollte, müssen Sie einen gesonderte Schlüssel in Ihrem GoogleMaps-Konto generieren.";

$l['setting_usermap_width'] = "Breite der Usermap";
$l['setting_usermap_width_desc'] = "Passen Sie die Breite der Usermap an. Die Einheit ist Pixel";

$l['setting_usermap_height'] = "Höhe der Usermap";
$l['setting_usermap_height_desc'] = "Passen Sie Höhe der Usermap an. Die Einheit ist Pixel";
...
$l['setting_usermap_elevation_unit_desc'] = "wählen Sie zwischen 'Meter' und 'Feet' (Fuß)";

$l['setting_usermap_add_places_yesno'] = "Möchten Sie der Usermap sogenannte \"zusätzliche Orte/Plätze\" von besonderem Interesse hinzufügen?";
$l['setting_usermap_add_places_yesno_desc'] = "Wenn gewünscht, können Sie diese im nachfolgendem Textfeld, eintragen.";

$l['setting_usermap_add_places'] = "Fügen Sie zusätzliche Orte/Plätze von besonderem Interesse Ihrer Usermap hinzu";
$l['setting_usermap_add_places_desc'] = "Fügen Sie die Orte/Plätze, wie nachstehend erläutert, hinzu und verwenden Sie für jeden Ort/Platz eine neue Zeile (siehe Beispiele im Textfeld).<br />
<br />
Achten Sie bitte darauf nur folgendes Format zu verwenden: <strong>[Name des Ortes/Platzes, Latitude-Wert, Longitude-Wert, z-index]</strong><br />
<ul><li><strong>Name des Ortes/Platzes:</strong> String. Sie können HTML, CSS, URLs und img-tags verwenden (siehe u.a. Beispiele)</li>
...
<li>Sollten Sie die Höhenlage der/des Orte/s / Platzes anzeigen wollen, müssen Sie diese/n selbst ermitteln und den Wert bei <strong>Name des Ortes/Platzes</strong> hinzufügen.</li></ul>";
$l['setting_usermap_add_places_guests'] = "Zeige die sogenannten \"zusätzlichen Orte/Plätze\" auch den Gästen?";
$l['setting_usermap_add_places_guests_desc'] = "Wenn nicht, können Gäste die zusätzlichen Orte/Plätze nicht sehen.";

$l['setting_usermap_add_places_icon'] = "Möchten Sie als PIN, für die zusätzlichen Orte/Plätze, das Google-Maps Info Icon verwenden?";
$l['setting_usermap_add_places_icon_desc'] = "Wenn nicht, können Sie nachfolgend ein eigenes PIN-Bild für diese Plätze verwenden.";

$l['setting_usermap_add_places_icon_own'] = "Hier können Sie den Dateinamen des eigenen PIN-Bildes für die zusätzlichen Orte/Plätze angeben";
$l['setting_usermap_add_places_icon_own_desc'] = "Setzen Sie den Namen des Bildes in die folgende Zeile eine. Das PNG-File muss im Verzeichnis: \"./images/pinimgs/\" zur Verfügung stehen.";
?>